...
exports.generateAssessmentAI = void 0;
const dotenv_1 = __importDefault(require("dotenv"));
dotenv_1.default.config();
const generateAssessmentAI = async (params) => {
...
exports.generateAssessmentAI = generateAssessmentAI;
// Generates highly realistic, academically styled questions for testing
const generateLocalSynthesizedAssessment = (params) => {
    const sections = [];
    ...
    const generateQuestionText = (type, diff, idx) => {
